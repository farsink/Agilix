...
const HowWeDoIt: React.FC = () => {
  return (
    <section id='Howitworks'>
      <div className='max-w-6xl mx-auto px-6 py-16 bg-gray-50 overflow-hidden rounded-b-4xl backdrop-blur-3xl'>
        <div className='text-center mb-16'>
          <span className='inline-block bg-blue-50 text-orange-500 px-4 py-2 rounded-full text-sm font-semibold tracking-wide uppercase mb-4'>
            PROCESS
          </span>
