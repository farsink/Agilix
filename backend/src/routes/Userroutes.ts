...
router.get('/isRegistered', userAuth.authenticate, isRegistered);

router.post('/', uplaod.none(), userAuth.authenticate, userProfileController.setupUserProfile.bind(userProfileController));
...
router.get('/profile', userAuth.authenticate, userProfileController.getUserProfile.bind(userProfileController));
